    ...
    <div className="flex flex-col p-8 pb-6 min-w-[42%] max-w-[42%] border-r border-neutral-800">
      {ui.stage === "onboarding" && (
          ...
          description={
            ui.isCompatible === false ? (
              ...
              <>
                ...
                <b>{installer.profile.name}</b>! This will automatically create
                a separate profile in the Minecraft Launcher for you.
                <br />
                <br />
                <span className="text-red-400">
                  Use the <b>Manual Install</b> option if you experience issues.
                </span>
              </>
            )
          }
        >
          <ActionButton
            ...
            href={
              ui.isCompatible === false && `${installer.profile.key}/manual`
            }
      ...
      {ui.stage === "fileaccess" && (
        <CardLayout
          ...
          description={
            <>
              Please drag &apos;n drop the <b>{path || "Loading..."}</b> folder
              to this window. Ensure Minecraft is closed.
            </>
          }
        />
      )}
        ...
        <CardLayout
          ...
          description={
            <>
              ...
              <b>{installer.profile.name}</b> from your Minecraft launcher.
            </>
          }
        />
      )}
